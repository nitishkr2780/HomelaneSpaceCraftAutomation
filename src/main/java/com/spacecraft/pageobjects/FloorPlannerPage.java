...
public class FloorPlannerPage {
    ...
    List<WebElement> roomListItemsLocator;
    ...
    public void selectFirstBedUnitAndAddToCart() {
        ...
        WebElement product = productList.getFirst();
    ...
    public CartPage clickOnaddedCartOption() {
        addedCartOptionLocator.click();
    ...
    public void selectFirstServiceItem() {
        ...
        WebElement firstServiceItem = servicesItemListsLocator.getFirst();
